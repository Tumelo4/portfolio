...
import {styleBox} from "@/components/AboutSection";
        ...
        <Fade in={openMore}>
          <Box sx={styleBox}>
            <div className=' h-screen overflow-y-scroll'>
              <div className='p-6 w-full flex flex-col gap-8 bg-light-primary dark:bg-dark-primary'>
                <h1 className=' w-full text-center text-[2rem] font-bold mb-4 pointer-events-none uppercase'>My <span className=' text-[#00BFFF] capitalize'>skills</span></h1>
                <div className=' flex flex-wrap gap-8 justify-center pointer-events-none '>
                  {
